...
struct ContentView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Cutting Board Care")
            .toolbar {
...
struct EntryFormView: View {
    ...
    init(entry: Entry?, onSave: @escaping (Entry) -> Void) {
        _fieldValue = State(initialValue: entry?.boardName ?? "")
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                Form {
                    Section("Board name") {
                        TextField("Board name", text: $fieldValue)
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        let entry = Entry(
                            id: entryID ?? UUID(),
                            boardName: fieldValue.isEmpty ? "Untitled" : fieldValue,
                            date: date,
                            note: note
                        )
                        onSave(entry)
